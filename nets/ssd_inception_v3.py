...
class SSDNet(object):
    """Implementation of the SSD Inception_v3 300 network.

    The default features layers with 229 x 229 image input are:
      Mixed_5c ==> 35 x 35 x 192
      Mixed_6e ==> 17 x 17 x 768
      Mixed_7c ==> 8 x 8 x 2048
      conv9 ==> 4 x 4
      conv10 ==> 2 x 2
      conv11 ==> 1 x 1
    ...
    default_params = SSDParams(
        ...
        feat_shapes=[(35, 35), (19, 19), (8, 8), (4, 4), (2, 2), (1, 1)],
...
def ssd_net(inputs,
    ...
    end_points = {}
    with tf.variable_scope(scope, 'ssd_inception_v3', [inputs], reuse=reuse):
        # Original inception_v3 blocks.
